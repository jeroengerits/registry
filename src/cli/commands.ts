...
export { removeComponent } from './commands/component/remove.js';
export { selfUpdate } from './commands/self-update.js';
export { toggleComponent } from './commands/component/toggle.js';
export { updateComponent } from './commands/component/update.js';
